...
const WhyChooseCard = ({
  ...
  return (
    <motion.div
      className="group relative bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-black/10 dark:border-white/10 rounded-xl p-6 h-full hover:bg-white/80 dark:hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 shadow-sm dark:shadow-none"
      whileHover={{ 
        y: -8,
    ...
    >
      ...
      <h3 className="text-lg font-bold mb-3 text-neutral-900 dark:text-neutral-100 group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors duration-300">
        {title}
      </h3>
...
export function WhyChooseMeSection() {
  ...
  return (
    <section className="relative py-20 px-4 sm:px-8 md:px-16 lg:px-24 bg-background text-foreground overflow-hidden">
